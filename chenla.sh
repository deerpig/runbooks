...
SITE_SRC=$HOME/proj/chenla/chenla-html
SITE_BUILD=$HOME/proj/chenla/chenla-org

# make sure the script is in the path
export PATH=$PATH:/home/deerpig/bin/ ;

# Change to build dir and fetch any changes from any
# deployment from other boxes
cd $SITE_BUILD && \
