...
** Knife
For some reason, =chef generate cookbook= is completely
fucking up for me.  I think it's because I need ruby 2.2 and
I have ruby 2.1 installed on Boris.  In fact it looks like
it isn't worth getting into this at all -- Berkfile will
have to wait until I've mastered the basics....

So we'll use knife to create cookbooks
...
with VirtualBox, Vagrant and Chef.  Here's how:
  ...
  - edit .kitchen.yml
  - kitchen create default-centos-83
  ...
  - kitchen destroy default-centos-83
...
This is a work around for doing local chef development -- it
is insecure and MUST NOT be used in a production environent.
